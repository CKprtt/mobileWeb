...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityTextToSpeech", path: "../../../../../node_modules/.pnpm/@capacitor-community+text-to-speech@8.0.0_@capacitor+core@8.1.0/node_modules/@capacitor-community/text-to-speech"),
